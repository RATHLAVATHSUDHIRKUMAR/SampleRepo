...
| 9 | Train five anatomy-guided lesion folds | **In progress** | Five-epoch smoke test reached pseudo-Dice 0.1281. Full Fold 0 epoch 0 reached 0.0728 and wrote a valid checkpoint to D:; training continues with one augmentation worker. |
